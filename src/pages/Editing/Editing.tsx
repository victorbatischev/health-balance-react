...
export const Editing = () => {
  ...
  const handlerTelephone = (e: React.ChangeEvent<HTMLInputElement>) =>
    setTelephone(e.target.value);
  const handlerBirthday = (e: React.ChangeEvent<HTMLInputElement>) =>
    setBirthday(e.target.value);
  const handlerUserName = (e: React.ChangeEvent<HTMLInputElement>) =>
    setUserName(e.target.value);
  const handlerSurname = (e: React.ChangeEvent<HTMLInputElement>) =>
  ...
  const additionalHeaderComponent = (
    <div style={{ color: "#56CCF2" }}>Готово</div>
  );
  ...
  return (
    <div className={"editing"}>
      ...
      <div className="editing__row">
        ...
        <div
          className={"editing__gender select-gender"}
